...
func TestParseSolutionLogName(t *testing.T) {
	encoder_, step, targetHash, err := parseSolutionLogName("transalg_md4_41_ffffffffffffffffffffffffffffffff_dobbertin31.cnf.cadical_c1000000.cnf.march_n2460.cubes.cube79837.kissat.log")
...
func TestParseSolutionLogName2(t *testing.T) {
	encoder_, step, targetHash, err := parseSolutionLogName("saeed_e_md4_35_00000000000000000000000000000000_dobbertin31.cnf.cadical_c1000000.cnf.march_n2460.cubes.cube79837.kissat.log")
